...
const BugReportsPage = () => {
  ...
  case 'closed': return 'bg-gray-100 text-muted-foreground dark:bg-muted/50 dark:text-muted-foreground';
  default: return 'bg-gray-100 text-muted-foreground dark:bg-muted/50 dark:text-muted-foreground';
    }
  };

  const getPriorityColor = (priority: string) => {
    switch (priority) {
  case 'low': return 'bg-gray-100 text-muted-foreground dark:bg-muted/50 dark:text-muted-foreground';
  ...
  <h1 className="text-4xl font-bold text-foreground mb-8">Bug Reports</h1>
  ...
  <div className="space-y-8">
        ...
        {/* Quick Email Report */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">Quick Email Report</h2>
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Email Bug Report</h3>
                <p className="text-muted-foreground text-sm">Direct line to our development team</p>
              </div>
            </div>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">What to Include in Your Report</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">📝 Essential Information</h3>
        ...
        {/* Web Form */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">Web Form Submission</h2>
          ...
          {submitStatus.type && (
            <div className={`mb-6 p-4 rounded-lg border ${
              submitStatus.type === 'success'
                ? 'bg-green-50 border-green-200 text-green-800 dark:bg-green-900/30 dark:text-green-300 dark:border-green-800'
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 disabled:bg-muted/50 disabled:cursor-not-allowed"
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors disabled:bg-muted/50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
        ...
        {/* Your Bug Reports */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">Your Bug Reports</h2>
          <p className="text-muted-foreground leading-relaxed mb-6">
          ...
          {isLoadingReports ? (
            ...
            <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
              <div className="flex items-center">
                <AlertCircle className="w-5 h-5 text-red-600 dark:text-red-300 mr-2" />
                <p className="text-red-800 dark:text-red-300 text-sm">Failed to load your reports: {reportsError}</p>
              </div>
              <button
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-foreground mb-2">No Bug Reports Yet</h3>
            ...
            <div className="space-y-4">
              {userReports.map((report) => (
                <div key={report._id} className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <span className="text-sm text-muted-foreground ml-2">{report.name}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-foreground">Email:</span>
                      <span className="text-sm text-muted-foreground ml-2">{report.email}</span>
                    </div>
                    <div>
                    ...
                    {report.resolution && (
                      <div className="border-t pt-3">
                        <span className="text-sm font-medium text-green-700 dark:text-green-300 block mb-1">Resolution:</span>
                        <p className="text-sm text-green-600 dark:text-green-300 bg-green-50 dark:bg-green-900/30 rounded p-3">
                          {report.resolution}
                        </p>
                      </div>
                    )}
        ...
        {/* Common Issues */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">Common Issues & Quick Fixes</h2>

          <div className="space-y-4">
            <div className="bg-muted/50 rounded-lg p-4">
              <h3 className="font-medium text-foreground mb-2">🐛 App Won't Load or Crashes</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              <h3 className="font-medium text-foreground mb-2">📷 Camera/Photo Upload Issues</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              <h3 className="font-medium text-foreground mb-2">🔐 Login Problems</h3>
              <p className="text-muted-foreground text-sm">
