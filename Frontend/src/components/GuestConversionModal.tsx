    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-2xl p-0 overflow-hidden border-0 shadow-2xl">
        ...
        <Button
          variant="ghost"
          size="sm"
          className="absolute right-4 top-4 z-10 h-8 w-8 p-0 hover:bg-white/20"
          onClick={handleClose}
        >
          <X className="h-4 w-4" />
        </Button>
        ...
        {/* Header Section */}
        <div className="bg-gradient-to-br from-green-500 via-green-600 to-emerald-700 text-white p-8 relative overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {features.map((feature, index) => (
              <div key={index} className="flex items-start space-x-3 p-4 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h4 className="font-semibold text-gray-900">Join our growing community</h4>
                <p className="text-gray-600 text-sm">See what our users are saying</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-3 rounded border border-gray-200">
                <p className="text-sm text-gray-700 mb-2">"The AI suggestions saved my dying tomato plants!"</p>
              ...
              <div className="bg-white p-3 rounded border border-gray-200">
                <p className="text-sm text-gray-700 mb-2">"Smart reminders keep my garden thriving!"</p>
                <div className="flex items-center space-x-2">
          ...
          <div className="space-y-3">
            <Button 
              asChild 
              size="lg" 
              className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-4"
            >
          ...
          <div className="text-center mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
            <div className="flex items-center justify-center space-x-2 text-green-700">
              <Shield className="w-4 h-4" />
              <span className="text-sm font-medium">100% Free • No Credit Card Required • Privacy Protected</span>
            </div>
          </div>
        </div>
      </DialogContent>
