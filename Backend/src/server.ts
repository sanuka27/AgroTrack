...
if (isFeatureEnabled('aiSuggestions')) app.use('/api/ai/suggestions', aiSuggestionsRoutes);
if (isFeatureEnabled('communityForum')) app.use('/api/community/forum', communityForumRoutes);
